...
public class endGame{
	...
	public static void main(String [] args){
		...
		//try and except to input the highscore from a .txt file and outputs it to a list of arrays.
		try {
		...
		//This should sort the array in ascending order, by sorting the list and appending to another list.
